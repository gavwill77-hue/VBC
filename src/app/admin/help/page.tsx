    ...
    <div className="space-y-6">
      ...
      <section className="panel">
        ...
        <div className="mt-3 space-y-3 text-sm text-slate-700">
          ...
          <p><span className="font-semibold">Exclude worse than double bogey from Callaway deductions:</span> Holes worse than double bogey are not deductible and always count at full value in round scoring.</p>
